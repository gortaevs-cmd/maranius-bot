...
MSG_STORE_STUB = (
    f"<b>{BTN_STORE}</b>\n\n"
    "Каталог товаров на сайте Maranius."
)

MSG_MORE = (
    f"<b>{BTN_MORE}</b>\n\n"
    "Дополнительные разделы и сервисы:"
)
...
MSG_INFO_FAQ = (
    ...
    "Внизу 4 кнопки: Сегодня, VIP, Лавка, Ещё. Основной вход — «Сегодня».\n\n"
    "<b>2. Ангельские знаки</b>\n"
    "Пиши число или время в чат (11:11, 22:30, 7). Ответ придёт автоматически.\n\n"
    "<b>3. Карта дня</b>\n"
    "Подсказки Вселенной и кристалл дня на maranius.ru — по одному разу в сутки.\n\n"
    "<b>4. Моё VIP</b>\n"
    "После покупки колоды — код доступа и инструкции ко всем колодам.\n\n"
    "<b>5. Лавка</b>\n"
    "Каталог товаров на maranius.ru.\n\n"
    "<b>6. Курсы и Крайон</b>\n"
    "Курсы — school.maranius.ru; практики 7/21/33 — @KryonCrystalsBot.\n\n"
    "<b>7. Услуги</b>\n"
    "Целительские практики — «Ещё → Услуги».\n\n"
    "<b>8. Связь с автором</b>\n"
    f"Товары, платформа, бот — /contact или {CONTACTS_HTML}.\n\n"
    "<b>9. Погода и Луна</b>\n"
    "Сервисы в «Ещё», не практика дня.\n\n"
    "<b>10. Кубик</b>\n"
    "Один бросок в сутки — подсказка в «Сегодня»."
)
